              ...
              <article class="entry entry-single" data-aos="fade-up">
                ...
                <div class="entry-footer clearfix">
                  <div class="float-left">
                    ...
                    <ul class="cats">
                      <li><a href="{{ route('filter_by_category', $post->category->name) }}">{{$post->category->name}}</a></li>
              ...
              <div class="blog-comments" data-aos="fade-up">
                ...
                <div id="comment-2" class="comment clearfix">
                  ...
                  <div id="comment-reply-1" class="comment comment-reply clearfix">
                    <img src="{{ asset('frontend/assets/img/comments-3.jpg') }}" class="comment-img  float-left" alt="">
                    ...
                    <div id="comment-reply-2" class="comment comment-reply clearfix">
                      <img src="{{ asset('frontend/assets/img/comments-4.jpg') }}" class="comment-img  float-left" alt="">
                ...
                <div id="comment-3" class="comment clearfix">
                  <img src="{{ asset('frontend/assets/img/comments-5.jpg') }}" class="comment-img  float-left" alt="">
                ...
                <div id="comment-4" class="comment clearfix">
                  <img src="{{ asset('frontend/assets/img/comments-6.jpg') }}" class="comment-img  float-left" alt="">
